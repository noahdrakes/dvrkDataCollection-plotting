...
plt.plot(df1['TIMESTAMP'], df1['ENCODER_POS_3'], label='Encoder Count with no obstacle')

# Plot the second data set
plt.plot(df2['TIMESTAMP'], df2['ENCODER_POS_3'], label='Encoder Count with obstacle')
